...
const Section =()=>{  
    return(
        ...
        <div className="flex items-center " >
            ...
            <div className="right bg-blue-600 h-[437px] items-center pt-8 text-center" style={{borderRadius:"0px 40px 40px 0px"}} >
                <p>"Aqlli shahar" tushunchasining umumiy qabul qilingan ta'rifi mavjud emas. <br /> Parametrlar boʻyicha kelishuvsiz aqlli shahar tashabbuslarini baholash qiyin boʻladi. <br /> Bu, shuningdek, loyihalarni solishtirish va eng yaxshi amaliyotlarni aniqlash qobiliyatiga <br /> to'sqinlik qiladi.Aqlli shahar - bu ma'lumotlarni to'plash va xizmat ko'rsatish uchun <br /> raqamli texnologiyalardan foydalanadigan shahar hududidir . Maʼlumotlarni  <br /> fuqarolardan, qurilmalardan, binolardan, kameralardan toʻplash mumkin. Ilovalar  <br /> transport va transport tizimlari , elektr stantsiyalari , kommunal xizmatlar,  <br /> shahar o'rmon xo'jaligi ,suv ta'minoti tarmoqlari , chiqindilarni utilizatsiya qilish,  <br /> jinoiy tergov , axborot tizimlari , maktablar , kutubxonalar , shifoxonalar va boshqa  <br />jamoat xizmatlarini o'z ichiga oladi .Aqlli shaharlar mahalliy hukumatlarning shaharni kuzatish,  <br /> tahlil qilish, rejalashtirish va boshqarish usullari bilan tavsiflanadi . Aqlli shaharda ma'lumotlar <br />   almashinuvi ushbu ma'lumotlardan foydalanishdan foyda olishlari mumkin bo'lgan korxonalar,  <br /> fuqarolar va boshqa uchinchi tomonlarga taalluqlidir.2022 yil holatiga koʻra aqlli shaharlar bilan  <br /> bogʻliq uchta eng katta xarajatlar manbalari vizual kuzatuv, jamoat transporti va tashqi yoritish edi.</p>
            </div>
            </div>
            <h1 className="text-center" style={{fontSize:"40px"}}>Eco city</h1>
            <div className="">
                <div className="flex items-center justify-around">
                    <img src="eco.jpg" alt="" style={{borderRadius:"40px 40px 40px 40px", width:"45%", height:"500px"}}  />
                    <img src="eco1.jpg" alt="" style={{borderRadius:"40px 40px 40px 40px", width:"45%", height:"500px"}}  />
                </div>
            </div>
